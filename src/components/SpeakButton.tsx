...
export function SpeakButton({ text }: SpeakButtonProps) {
  ...
  return (
    <button
      ...
      className="inline-flex flex-none items-center gap-1.5 rounded-full border border-ink/15 bg-white px-3 py-1.5 text-sm font-medium text-ink transition hover:border-marigold focus-visible:outline-none"
    >
